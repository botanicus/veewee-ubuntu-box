...
veewee vbox build ubuntu-14.04-amd64 -n --force && veewee vbox export ubuntu-14.04-amd64 --force && vagrant box remove ubuntu-14.04-amd64 && vagrant box add ubuntu-14.04-amd64 ubuntu-14.04-amd64.box && scp ubuntu-14.04-amd64.box server:/webs/static
```
